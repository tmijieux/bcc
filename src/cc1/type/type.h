...
extern const struct type * type_signed_char;
extern const struct type * type_unsigned_char;

extern const struct type * type_short;
extern const struct type * type_unsigned_short;

extern const struct type * type_int;
extern const struct type * type_unsigned_int;

extern const struct type * type_long;
extern const struct type * type_unsigned_long;

extern const struct type * type_long_long;
extern const struct type * type_unsigned_long_long;

extern const struct type * type_float;
extern const struct type * type_double;
 ...
 *  of a function
 */
extern const struct type *last_function_return_type;
